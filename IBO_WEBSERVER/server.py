...
class SimpleHTTPRequestHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        if self.path == '/':
            ...
            self.path = 'html_files/about.html'
        elif self.path == '/contact':
            self.path = 'html_files/contact.html'
        elif self.path.endswith('.css'):
            self.path = 'styles' + self.path  # Adjust the path accordingly
...
server_cert = "ibo.com-2024-04-25.crt"
server_key = "ibo.com-2024-04-25.key"
